...
/**
 * REESCRITOR COM IA (usando Anthropic API)
...
async function reescreverComIA(texto) {
    try {
        ...
        if (!process.env.ANTHROPIC_API_KEY) {
            console.log('⚠️ API key não configurada, usando reescritor básico');
        ...
        const response = await fetch('https://api.anthropic.com/v1/messages', {
            ...
            body: JSON.stringify({
                ...
                messages: [
                    {
                        role: 'user',
                        content: `Reescreva esta mensagem em tom de hippie noiado que gosta de erva. 
        ...
        const textoReescrito = data.content[0].text.trim();
